...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerViewModel = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ko = __webpack_require__(2);
	var doesMatch = __webpack_require__(25);
	...
	var PlayerViewModel = (function () {
	  function PlayerViewModel(songService) {
	    ...
	    songService.getSongs().then(function (_ref) {
	      var data = _ref.data;

	      ko.utils.arrayPushAll(_this.songsData, data);
	      _this.filterSongs();
	    });
